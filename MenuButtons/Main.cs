...
namespace UmbraMenu.MenuButtons
{
    public static class Main
    {
        ...
        private static void ESPButtonAction() => ToggleMenu(UmbraMenu.menus[6]);
        ...
        public static TogglableButton toggleESP = new TogglableButton(currentMenu, 6, "R E N D E R : O F F", "R E N D E R: O N", ESPButtonAction, ESPButtonAction);
