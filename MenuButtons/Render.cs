...
namespace UmbraMenu.MenuButtons
{
    public class Render
    {
        ...
        public static TogglableButton toggleActiveMods = new TogglableButton(currentMenu, 1, "A C T I V E   M O D S : O F F", "A C T I V E   M O D S : O N", ToggleRenderMods, ToggleRenderMods);
