...
namespace UmbraMenu.MenuButtons
{
    class Lobby
    {
        ...
        public static Button removeBuffs = new Button(currentMenu, 7, "L O B B Y : O F F", null);
        ...
        public static Button unlockAll = new Button(currentMenu, 11, "U N L O A D   M E N U", null);
