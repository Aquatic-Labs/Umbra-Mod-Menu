...
namespace Umbra_Mod_Menu.Model
{
    ...
    {
        public static MenuStyle DefaultMenuStyle = new MenuStyle("#333333", null, new Size(650, 425), 0.8, Properties.Resources.AquaticLabs_logo, FormBorderStyle.None, FormStartPosition.Manual, true, true);
